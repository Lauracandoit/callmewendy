    ...
    <main className='flex w-full flex-col items-center justify-center'>
      ...
      <div className='grid w-full grid-cols-8 gap-16 sm:gap-8  md:grid-cols-8'>
            <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:!col-span-8 '>
              ...
              <p className=' text-dark font-medium dark:text-light '> Hello! Im Wendy, and I have a genuine passion for creating captivating digital experiences. As a seasoned web developer, I specialize in building websites and mobile apps that are not just visually appealing but also intuitive and user-focused.</p>
