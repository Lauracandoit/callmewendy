        ...
        <Layout className='pt-0 md:p-16 sm:pt-8'> 
          <div className='flex items-center justify-between w-full lg:flex-col'>
            <div className='w-1/2 md:w-full'>
              <Image src={logo} className='w-full h-auto md:inline-block md:w-full'
               priority
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center lg:pt-3 '>
              ...
              <p className='my-4 text-base font-medium md:text-sm sm:text-xs '>  Thank you for checking in on my website. CallmeWendy is the place I share my personal projects, my passion with daily stuff and my personal experience day by day. 
              Hope you are enjoy the time here and find something interesting and helpful. Do not hesitate to reach out in case you have any questions for me. I wish you a nice journey and wonderful day </p>
              <div className='flex items-center self-start mt-2 lg:self-center '>
                  <Link href = '/lenguyet.pdf' target={'_blank'} className='flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg border-white font-semibold hover:bg-white hover:text-black border-solid border-transparent hover:border-blackk border-2 dark:bg-light dark:text-dark hover:dark:bg-dark hover:dark:text-light hover:dark:border-light md:p-2 md:px-4 md:text-base'  download = {true} > Resume </Link>
                  <Link href="mailto:wendy.wnd77@gmail.com" className='ml-4 text-lg font-medium capitalize text-dark underline dark:text-light md:text-base'> Contact</Link>
              </div> 
          </div>
          </div>
        </Layout>
